package com.example.android.beautysalon.Database;
...
public class DatabaseUtils {
    ...
    public static void deleteCart(@NonNull CartDatabase db, CartItem cartItem) {
...
//    }
    ...
    private static class UpdateCartAsync extends AsyncTask<CartItem, Void, Void> {
        ...
        public UpdateCartAsync(CartDatabase cartDatabase) {
            db = cartDatabase;
        }
...
//        }
    ...
    private static class InsertToCartAsync extends AsyncTask<CartItem, Void, Void> {
        ...
        @Override
        protected Void doInBackground(CartItem... cartItems) {
            insToCart(db, cartItems[0]);
            return null;
        }

        private void insToCart(CartDatabase db, CartItem cartItem) {
            try {
    ...
    private static class DeleteCartAsync extends AsyncTask<CartItem, Void, Void> {
        ...
        public DeleteCartAsync(CartDatabase cartDatabase) {
            db = cartDatabase;
        }
    ...
    private static class ClearCartAsync extends AsyncTask<Void, Void, Void> {
        ...
        public ClearCartAsync(CartDatabase cartDatabase) {
            db = cartDatabase;
        }
