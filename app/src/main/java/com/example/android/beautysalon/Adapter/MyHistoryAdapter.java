...
public class MyHistoryAdapter extends RecyclerView.Adapter<MyHistoryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        holder.txt_booking_master_text.setText(bookingInformationList.get(position).getMasterName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.txt_booking_master_text)
        TextView txt_booking_master_text;
